...
# SOCIAL_AUTH_GOOGLE_OAUTH2_REDIRECT_URI = "http://127.0.0.1:8000/complete/google-oauth2/" #jacob test
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'main.pipeline.ensure_profile_completion',  #profile completion pipeline
